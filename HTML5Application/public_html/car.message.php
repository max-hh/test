...
<!--[if gt IE 8]><!--> <html lang="en"> <!--<![endif]-->
 ...
 echo "<div class='login'>";
    echo "<h1>Sende eine Nachricht</h1>";
     if(isset($_POST['send']))
        {
        echo "Danke! Deine Nachricht wurde an den User geschickt";
        }
   echo "<form name='sendMessageForm' action='' method='post'>";
   echo "<table>";
   echo "<tr><td colspan='2' ><textarea name='messageText'></textarea></td></tr>";
   echo "<tr><td align='center'><input type='submit' value='Send' name='send'/></td></tr>";
