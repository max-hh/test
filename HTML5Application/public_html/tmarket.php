...
// End Custom Icons
     ...
     var map;
      ...
      downloadUrl("tgmaps.php", function(data) {
        ...
        for (var i = 0; i < markers.length; i++) {
         ...
         var id = markers[i].getAttribute("id");
          ...
          var html = "<b>" + name + "</a></b> <br/>" + address +"<br /><a href='trans.details.php?" + id +"'>Details</a><br /><b></b>" ;
...
// Additional functions related to the 'other' DB Listing function
  ...
  <section class="container">
   ...
   echo  "</br>";
    if($setFailed){
     echo "</br>";
    echo "Du hast bereist einen Anfrage an diesen User geschickt!";
     echo "</br>";
    }
     if($set){
     echo "</br>";
