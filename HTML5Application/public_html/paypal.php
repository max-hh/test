...
switch ($_GET['action']) {
   ...
   case 'process':      // Process and order...
      ...
      $p->add_field('business', $recipient);
   ...
   case 'success':      // Order was successful...
      ...
      echo "<br/><p><b>Thank you for your Payment. </b><br /></p>";
   ...
   case 'cancel':       // Order was canceled...
      ...
      echo "<br/><p><b>The payment was canceled befor being completed!</b></p><br />";
    foreach ($_POST as $key => $value) { echo "$key: $value<br>"; }
   ...
   case 'ipn':          // Paypal is calling page for IPN validation...
      ...
      if ($p->validate_ipn()) {
         ...
         $to = 'm.harms@harborgrown.com';    //  your email
